package com.graduate.work.entity_and_event_generator.service.random.updater.external;
...
public class ModemExternalUpdater extends ExternalUpdater<Modem> {
    ...
    RandomAction<Modem> addSimCard = (modem) -> {
        ...
        if (modem.getSimCards().size() >= com.graduate.work.entity_and_event_generator.service.random.data.Modem.COUNT_SIM_CARDS) {
            return modem;
        }
